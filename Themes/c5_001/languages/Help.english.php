...
$helptxt['live_news']
	= '<strong>Live announcements</strong><br>
...
$helptxt['registrations']
	= '<strong>Registration Management</strong><br>
...
$helptxt['modlog']
	                           = '<strong>Moderation Log</strong><br>
...
$helptxt['adminlog']
	                           = '<strong>Administration Log</strong><br>
...
$helptxt['warning_enable']
	                           = '<strong>User Warning System</strong><br>
...
$helptxt['smileys']
	                                  = '<strong>Smiley Center</strong><br>
...
$helptxt['userLanguage']
                                               = 'Turning this setting on will allow users to select which language file they use. It will not affect the
		default selection.';
$helptxt['trackStats']
                                               = 'Stats:<br>This will allow users to see the latest posts and the most popular topics on your forum.
...
$helptxt['titlesEnable']
                                               = 'Switching Custom Titles on will allow members with the relevant permission to create a special title for themselves.
...
$helptxt['todayMod']
                                               = 'This will show &quot;Today&quot; or &quot;Yesterday&quot; instead of the date.<br><br>
...
$helptxt['pollMode']
                                               = 'This selects whether polls are enabled or not. If polls are disabled, any existing polls will be hidden
...
$helptxt['enableCompressedOutput']
                                               = 'This setting will compress output in order to lower bandwidth consumption, but it requires
		zlib to be installed.';
$helptxt['disableTemplateEval']
                                               = 'By default, templates are evaluated instead of just included. This helps with showing more useful debug information in case a template contains an error.<br><br>
...
$helptxt['compactTopicPagesEnable']
                                               = 'This will just show a selection of the number of pages.<br><em>Example:</em>
...
$helptxt['cal_enabled']
                                               = 'The calendar can be used for showing birthdays, or for showing important events happening in your community.<br><br>
...
$helptxt['localCookies']
                                               = 'SMF uses cookies to store login information on the client computer.
...
$helptxt['themes']
	                                       = 'Here you can select whether the default theme can be chosen, what theme guests will use,
...
$helptxt['enableEmbeddedFlash']
	                                       = 'This setting will allow your users to use Flash directly inside their posts,
	just like images. This could pose a security risk, although few have successfully exploited it.
	USE AT YOUR OWN RISK!';
$helptxt['xmlnews_enable']
	                                       = 'Allows people to link to <a href="%1$s?action=.xml;sa=news" target="_blank" class="new_win">Recent news</a>
...
$helptxt['globalCookies']
	                                       = 'Makes log in cookies available across subdomains. For example, if...<br>
...
$helptxt['customoptions']
	= 'This defines the options that a user may choose from a drop down list. There are a few key points to note on this page:
	<ul class="normallist">
...
$helptxt['queryless_urls']      = 'This changes the format of URLs a little so search engines will like them better. They will look like index.php/topic,1.0.html.<br><br>This feature will ' . ( isset( $_SERVER['SERVER_SOFTWARE'] ) && ( strpos( $_SERVER['SERVER_SOFTWARE'],
                                                                                                                                                                                                                                                    'Apache' ) !== FALSE || strpos( $_SERVER['SERVER_SOFTWARE'],
                                                                                                                                                                                                                                                                                    'lighttpd' ) !== FALSE ) ? '' : 'not' ) . ' work on your server.';
...
$helptxt['registration_method']
	= 'This setting determines what method of registration is used for people wishing to join your forum. You can select from:<br><br>
	<ul class="normallist">
		<li>
...
$helptxt['password_strength']
                                       = 'This setting determines the strength required for passwords selected by your forum users. The stronger the password, the harder it should be to compromise member\'s accounts.
...
$helptxt['coppaAge']
	                    = 'The value specified in this box will determine the minimum age that new members must be in order to be granted immediate access to the forums.
...
$helptxt['coppaType']
	                    = 'If age restrictions are enabled, then this setting will define what happens when a user below the minimum age attempts to register with your forum. There are two possible choices:
	<ul class="normallist">
		<li>
...
$helptxt['membergroups']
                                        = 'In SMF there are two types of groups that your members can be part of. These are:
	<ul class="normallist">
...
$helptxt['show_spider_online']
                         = 'This setting allows you to select whether spiders should be listed in the &quot;Who\'s Online&quot; list on the board index and &quot;Who\'s Online&quot; page. The options are:
	<ul class="normallist">
		<li>
...
$helptxt['field_show_enclosed']
	= 'Encloses the user input between some text or html. This will allow you to add more instant message providers, images or an embed etc. For example:<br><br>
...
$helptxt['custom_mask']
	= 'The input mask is important for your forum\'s security. Validating the input from a user can help ensure that data is not used in a way you do not expect. We have provided some simple regular expressions as hints.<br><br>

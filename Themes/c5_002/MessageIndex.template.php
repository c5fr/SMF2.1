	...
	<div id="description_board" class="generic_list_wrapper">
		...
		', $context['description'], '&nbsp;';
			...
			if ( ! empty( $context['moderators'] ) ) {
				echo '
		', count( $context['moderators'] ) === 1 ? $txt['moderator'] : $txt['moderators'], ': ', implode( ', ',
	...
	<form action="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" class="clear" name="quickModForm" id="quickModForm">';
		...
		if ( ! empty( $settings['display_who_viewing'] ) ) {
			...
			if ( $settings['display_who_viewing'] == 1 ) {
				...
				echo empty( $context['view_members_list'] ) ? '0 ' . $txt['members'] : implode( ', ',
				                                                                                $context['view_members_list'] ) . ( empty( $context['view_num_hidden'] ) || $context['can_moderate_forum'] ? '' : ' (+ ' . $context['view_num_hidden'] . ' ' . $txt['hidden'] . ')' );
			}
			echo $txt['who_and'], $context['view_num_guests'], ' ', $context['view_num_guests'] > 1 ? $txt['guests'] :
				$txt['guest'], $txt['who_viewing_board'];
		...
		if ( ! empty( $context['topics'] ) ) {
			echo '
					...
					<div class="stats">', $context['topics_headers']['replies'], ' / ', $context['topics_headers']['views'],
			'</div>
		...
		foreach ( $context['topics'] as $topic ) {
			...
			echo '
					...
					<div class="stats"><p>', $topic['replies'], ' ', $txt['replies'] . ( $topic['replies'] > 1 ? 's' : '' ), '<br>',
			$topic['views'], ' ',
			$txt['views'], '</p></div>
					<div class="lastpost">

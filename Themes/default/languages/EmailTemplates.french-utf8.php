...
$txt['resend_activate_message_body']
                                        = 'Merci d\'avoir rejoint {FORUMNAME}. Votre identifiant est {USERNAME}. En cas d\'oubli de votre mot de passe, vous pouvez le r&#233;initialiser en allant sur {FORGOTPASSWORDLINK}.
...
$txt['resend_pending_message_body']
                                       = 'Votre demande d\'inscription sur {FORUMNAME} a &#233;t&#233; re&#231;ue, {REALNAME}.
...
$txt['mc_group_reject_reason_body']
                                       = '{USERNAME},
...
$txt['admin_approve_activation_body']
                                         = 'Bienvenue {USERNAME} !
...
$txt['admin_register_activate_body']
                                        = 'Merci d\'avoir rejoint {FORUMNAME}. Votre identifiant est {USERNAME}. En cas d\'oubli de votre mot de passe, vous pouvez le r&#233;initialiser en allant sur {FORGOTPASSWORDLINK}.
...
$txt['admin_register_immediate_body']
                                         = 'Merci d\'avoir rejoint {FORUMNAME}. Votre identifiant est {USERNAME} et votre mot de passe est {PASSWORD}.

{REGARDS}';

$txt['new_announcement_subject'] = 'Nouvelle annonce : {TOPICSUBJECT}';
$txt['new_announcement_body']
                                 = '{MESSAGE}
...
$txt['notify_boards_once_body_body']
                                        = 'Un nouveau sujet, \'{TOPICSUBJECT}\', a &#233;t&#233; cr&#233;&#233; dans une section que vous surveillez.
...
$txt['alert_unapproved_reply_body']
                                       = 'A reply has been posted to \'{SUBJECT}\' by {POSTERNAME}.
...
$txt['alert_unapproved_post_body']
                                      = 'A new post, \'{SUBJECT}\', has been made which needs approved.
...
$txt['alert_unapproved_topic_body']
                                       = 'A new topic, \'{SUBJECT}\', has been made which needs approved.
...
$txt['paid_subscription_reminder_body']
                                           = '{REALNAME},
...
$txt['activate_reactivate_body']
                                    = 'Pour pouvoir valider à nouveau votre adresse e-mail, votre compte a été désactivé. Cliquez sur le lien suivant pour le réactiver:
{ACTIVATIONLINK}
...
$txt['report_to_moderator_body']
                                    = 'Le message suivant, "{TOPICSUBJECT}" par {POSTERNAME} a &#233;t&#233; rapport&#233; par {REPORTERNAME} dans une section que vous mod&#233;rez :
...
$txt['reply_to_moderator_body']
                                   = 'Previously, "{TOPICSUBJECT}" was reported to moderators.
...
$txt['report_member_profile_body']
                                      = 'The profile of "{MEMBERNAME}" has been reported by {REPORTERNAME}.
...
$txt['reply_to_member_report_body']
                                       = 'Previously, the profile of {MEMBERNAME} was reported.
...
$txt['notification_reply_body']
                                   = 'Une r&#233;ponse a &#233;t&#233; post&#233;e sur un sujet que vous surveillez par {POSTERNAME}.
...
$txt['notification_reply_body_body']
                                        = 'Une r&#233;ponse a &#233;t&#233; post&#233;e par {POSTERNAME} sur un sujet que vous surveillez.
...
$txt['notification_reply_once_body']
                                        = 'Une r&#233;ponse a &#233;t&#233; post&#233;e par {POSTERNAME} sur un sujet que vous surveillez.
...
$txt['notification_reply_body_once_body']
                                             = 'Une r&#233;ponse a &#233;t&#233; post&#233;e par {POSTERNAME} sur un sujet que vous surveillez.
...
$txt['notification_lock_body']
                                  = 'Un sujet que vous surveillez a &#233;t&#233; bloqu&#233; par {POSTERNAME}.
...
$txt['notification_unlock_body']
                                    = 'Un sujet que vous surveillez a &#233;t&#233; d&#233;bloqu&#233; par {POSTERNAME}.
...
$txt['notification_move_body']
                                  = 'Un sujet que vous surveillez a &#233;t&#233; d&#233;plac&#233; dans une autre section par {POSTERNAME}.
...
$txt['admin_notify_body']
                             = '{USERNAME} vient juste de s\'inscrire comme nouveau membre sur votre forum. Cliquez sur le lien ci-dessous pour voir son profil.
{PROFILELINK}

{REGARDS}';

$txt['admin_notify_approval_subject'] = 'Un nouveau membre s\'est inscrit';
$txt['admin_notify_approval_body']
                                      = '{USERNAME} vient juste de s\'inscrire comme nouveau membre sur votre forum. Cliquez sur le lien ci-dessous pour voir son profil.
{PROFILELINK}
...
$txt['admin_attachments_full_body']
                                       = '{REALNAME},
...
$txt['paid_subscription_refund_body']
                                         = '{REALNAME},
...
$txt['paid_subscription_new_body']
                                      = '{REALNAME},
...
$txt['paid_subscription_error_body']
                                        = '{REALNAME},
...
$txt['new_pm_body']
                       = 'Vous venez tout juste de recevoir un message personnel de la part de {SENDER} sur {FORUMNAME}.
...
$txt['new_pm_tolist_body']
                              = 'Vous et {TOLIST} venez tout juste d\'envoyer un message personnel par {SENDER} sur {FORUMNAME}.
...
$txtBirthdayEmails['happy_birthday_body']
                                             = 'Cher {REALNAME},
...
$txtBirthdayEmails['karlbenson1_body']
                                          = 'Nous aurions pu vous envoyer une carte d\'anniversaire. Nous aurions pu vous envoyer des fleurs ou un g&#226;teau.
...
$txtBirthdayEmails['nite0859_body']
                                       = 'Vos amis sur {FORUMNAME} voudraient prendre un peu de votre temps pour vous souhaiter un joyeux anniversaire, {REALNAME}. Si vous ne l\'avez pas fait r&#233;cemment, veuillez visiter notre communaut&#233; afin que d\'autres aient l\'opportunit&#233; de vous transmettre leurs voeux !
...
$txtBirthdayEmails['zwaldowski_body']
                                         = 'Cher {REALNAME},
...
$txtBirthdayEmails['geezmo_body']
                                     = 'Savez-vous qui f&#234;te son anniversaire aujourd\'hui, {REALNAME} ?
...
$txtBirthdayEmails['karlbenson2_body']
                                          = 'Nous esp&#233;rons que votre anniversaire est le meilleur que vous ayez eu quel que soit le temps, nuageux ou ensoleill&#233;.

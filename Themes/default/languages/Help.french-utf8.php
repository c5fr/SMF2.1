...
$helptxt['ban_members']
	= '<strong>Bannir des membres</strong><br />
...
$helptxt['featuresettings']
	= '<strong>Modifier les Options et Fonctionnalités</strong><br />
	Il y a plusieurs fonctionnalités dans cette section qui peuvent être changées à votre préférence.';

$helptxt['modsettings']
	= '<strong>Modifier les Caractéristiques et les Options</strong><br />
...
$helptxt['time_format']
	= '<strong>Format de l\'heure</strong><br />
...
$helptxt['live_news']
	= '<strong>En direct de Simple Machines...</strong><br />
...
$helptxt['modlog']
	                           = '<strong>Journal de Modération</strong><br />
...
$helptxt['adminlog']
	                           = '<strong>Journal d\'Administration</strong><br />
...
$helptxt['userlog']
	                           = '<strong>Profile Edits Log</strong><br>
...
$helptxt['warning_enable']
	                           = '<strong>Système d\'avertissement utilisateur</strong><br />
...
$helptxt['error_log']
	                                  = '<strong>Journal d\'Erreurs</strong><br />
...
$helptxt['theme_settings']
	                                  = '<strong>Réglages du Thème</strong><br />
...
$helptxt['smileys']
	                                  = '<strong>Gestionnaire de smileys</strong><br />
...
$helptxt['calendar']
	                                  = '<strong>Gérer le calendrier</strong><br />
...
$helptxt['serversettings']
	= '<strong>Paramètres Serveur</strong><br />
...
$helptxt['userLanguage']
                                               = 'Activer cette option permettra aux utilisateurs de sélectionner la langue dans laquelle le forum leur sera affiché.
	Cela n\'affectera pas la langue par défaut.';
$helptxt['trackStats']
                                               = 'Stats&nbsp;:<br />Ceci permettra aux visiteurs de voir les derniers messages postés et les sujets les plus populaires sur votre forum.
...
$helptxt['titlesEnable']
                                               = 'Activer les titres personnels permettra aux membres possédant les permissions suffisantes de s\'attribuer un titre spécial pour eux-mêmes.
...
$helptxt['todayMod']
                                               = 'Cette option affichera &quot;Aujourd\'hui&quot; ou &quot;Hier&quot; à la place de la date.<br /><br />
...
$helptxt['cache_memcached']
                                               = 'Veuillez noter que l\'utilisation de memcache nécessite que vous donniez quelques indications sur votre serveur dans les réglages à effectuer ci-dessous. Elles doivent être entrées sous forme de liste, dont les éléments sont séparés par une virgule, comme dans l\'exemple suivant :
...
$helptxt['compactTopicPagesEnable']
                                               = 'Ceci est le nombre de pages intermédiaires à afficher lors du visionnement d\'un sujet.<br /><em>Exemple&nbsp;:</em>
...
$helptxt['attachment_manager_settings']
                                               = 'Les fichiers joints sont des fichiers que les membres peuvent uploader, et attacher à un message.<br /><br />
...
$helptxt['attachmentEnable']
                                               = 'This setting enables you to configure how attachments can be made.<br><br>
	<ul class="normallist">
		<li>
...
$helptxt['cal_enabled']
                                               = 'Le calendrier peut êre utilisé afin d\'afficher les anniversaires et des dates importantes à votre communauté.<br /><br />
...
$helptxt['localCookies']
                                               = 'SMF utilise des témoins (&quot;cookies&quot;) pour conserver les informations de connexion d\'un membre. Les témoins peuvent être stockés dans un dossier global (monserveur.com) ou localement (monserveur.com/chemin/vers/mon/forum).<br />
...
$helptxt['enablePostHTML']
	= 'Ceci permet l\'utilisation de quelques balises HTML basiques&nbsp;:
...
$helptxt['xmlnews_enable']
                                         = 'Permet aux gens de faire référence aux <a href="%1$s?action=.xml;sa=news" target="_blank">dernières nouvelles</a>
...
$helptxt['globalCookies']
                                         = 'Permet l\'utilisation de témoins (<em>cookies</em>) indépendants du sous-domaine. Par exemple, si...<br />
...
$helptxt['email_members']
                                         = 'In this message you can use a few &quot;variables&quot;. These are:<br>
...
$helptxt['customoptions']
	= 'Cette section définit les options qu\'un utilisateur peut choisir à partir d\'une liste déroulante. Il y a quelques points clés à noter pour cette section:
	<ul class="normallist">
...
$helptxt['queryless_urls']      = 'Ceci modifie un peu la structure des URLs afin que les moteurs de recherche tels Google et Yahoo! les référencent mieux. Les URLs ressembleront à index.php/topic,1.0.html.<br /><br />Cette option ' . ( isset( $_SERVER['SERVER_SOFTWARE'] ) && ( strpos( $_SERVER['SERVER_SOFTWARE'],
                                                                                                                                                                                                                                                                                               'Apache' ) !== FALSE || strpos( $_SERVER['SERVER_SOFTWARE'],
                                                                                                                                                                                                                                                                                                                               'lighttpd' ) !== FALSE ) ? '<span style="color: green">est supportée</span>' : '<span style="color: red">n\'est pas supportée</span>' ) . ' par votre serveur.';
...
$helptxt['registration_method']
	= 'Cette fonction détermine quelle méthode d\'inscription doit être adoptée pour les gens désirant rejoindre votre forum. Vous pouvez sélectionner un de ces choix&nbsp;:<br /><br />
	<ul class="normallist">
		<li>
...
$helptxt['password_strength']
                                       = 'Ce réglage détermine le niveau de sécurité requis pour les mots de passe sélectionnés par les membres de votre forum. Plus ce niveau est &quot;élevé&quot;, plus il devrait être difficile de découvrir le mot de passe et de pirater leurs comptes.
...
$helptxt['coppaAge']
	                    = 'La valeur spécifiée dans ce champ détermine l\'àge minimum que doit avoir un membre pour avoir un accè immédiat aux sections.
...
$helptxt['coppaType']
	                    = 'Si la restriction d\'âge est active, ce paramètre définira ce qui se produit lorsqu\'un membre n\'ayant pas l\'âge minimum requis tente de s\'inscrire sur votre forum. Il existe deux choix possibles&nbsp;:
	<ul class="normallist">
		<li>
...
$helptxt['membergroups']
                                        = 'Dans SMF il y a deux types de groupes auxquels vos membres peuvent appartenir. Ce sont&nbsp;:
	<ul class="normallist">
...
$helptxt['show_spider_online']
                         = 'Ce paramètre vous permet de choisir si les robots seront montrés ou pas sur la liste des utilisateurs en ligne et la page &quot;Qui est en ligne&quot;. Les options&nbsp;:
	<ul class="normallist">
		<li>
...
$helptxt['field_show_enclosed']
	= 'Entoure le texte entré par l\'utilisateur par du texte ou du HTML, vous permettant d\'ajouter des fournisseurs de messagerie instantanée supplémentaires, des images ou intégrations multimédia, etc. Par exemple&nbsp;:<br /><br />
...
$helptxt['custom_mask']
	= 'Le masque d\'entrée est important pour la sécurité de votre forum. Valider le texte entré par un utilisateur peut vous permettre d\'éviter que ses données ne soient pas utilisées de manière inattendue. Vous pouvez utiliser des expressions régulières pour vous y aider.<br /><br />

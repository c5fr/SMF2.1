...
$txt['sql_file']                        = 'Le fichier de modification a été extrait. Il est accompagné d\'un fichier SQL afin de modifier votre base de données.  Vous devrez l’exécuter pour que la modification fonctionne correctement.';
...
$txt['could_not_package_backup'] = 'Une sauvegarde n\'a pu être générée avant de faire les changements. Aucun changement n\'a été effectue à ce moment (vous devrez soit changer les permissions d’écriture de Packages/backup ou désactiver les sauvegardes - non recommandé)';
...
$txt['package_will_fail_warning']
                                         = 'Au moins une erreur a été rencontrée lors d\'un test %1$s de ce paquet.<br>Il est <strong>vivement</strong> recommandé que vous ne continuiez pas avec %1$s à moins d\'être sûr de ce que vous faites et que vous avez fait très récemment une copie de sauvegarde de votre forum et de votre base de données.<br><br>
